    ...
    for (let month = 0; month <= maxMonths; month++) {
      if (month > 0) {
        if (currentBalance > 0.01 && month <= currentLoan.monthsRemaining) {
          ...
          const currentPrincipal = Math.min(currentLoan.monthlyPayment - currentInterest, currentBalance);
        ...
        if (newBalance > 0.01 && month <= newTotalPayments) {
          ...
          const newPrincipal = Math.min(newMonthlyPayment - newInterest, newBalance);
      ...
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        <Group justify="space-between" mb="md">
          ...
          <Group gap="xs">
            ...
            <Badge variant="light" color="blue" size="md">Mortgage Analysis</Badge>
          </Group>
        </Group>
            ...
            <Stack gap="md">
              ...
              <NumberInput
                ...
                onChange={(value) => setInputs(prev => ({
                  ...prev,
                  currentLoan: { ...prev.currentLoan, balance: Number(value) || 0 }
                }))}
                min={0}
                thousandSeparator=","
              ...
              <NumberInput
                ...
                onChange={(value) => setInputs(prev => ({
                  ...prev,
                  currentLoan: { ...prev.currentLoan, interestRate: Number(value) || 0 }
                }))}
                min={0}
                max={30}
                decimalScale={2}
              ...
              <NumberInput
                ...
                onChange={(value) => setInputs(prev => ({
                  ...prev,
                  currentLoan: { ...prev.currentLoan, monthlyPayment: Number(value) || 0 }
                }))}
                min={0}
                thousandSeparator=","
                leftSection={<DollarSign size={16} />}
              ...
              <NumberInput
                ...
                onChange={(value) => setInputs(prev => ({
                  ...prev,
                  currentLoan: { ...prev.currentLoan, monthsRemaining: Number(value) || 0 }
                }))}
                min={1}
              />
            </Stack>
          ...
          <Grid.Col span={{ base: 12, md: 6 }}>
            <Stack gap="md">
              ...
              <NumberInput
                ...
                onChange={(value) => setInputs(prev => ({
                  ...prev,
                  newLoan: { ...prev.newLoan, interestRate: Number(value) || 0 }
                }))}
                min={0}
                max={30}
                decimalScale={2}
              ...
              <NumberInput
                ...
                onChange={(value) => setInputs(prev => ({
                  ...prev,
                  newLoan: { ...prev.newLoan, closingCosts: Number(value) || 0 }
                }))}
                min={0}
                thousandSeparator=","
                leftSection={<DollarSign size={16} />}
              ...
              <Card withBorder p="md" className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
                <Group justify="space-between">
                  <Text size="sm" c="dimmed">New Monthly Payment</Text>
                  <Text size="xl" fw={700} c="blue">
                    ${results.newLoan.monthlyPayment.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                  </Text>
                </Group>
              </Card>
              ...
              <Card withBorder p="md" className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
                <Group justify="space-between">
                  ...
                  <Text size="xl" fw={700} c="green">
                    ${results.savings.monthly.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                  </Text>
                </Group>
              </Card>
      ...
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        <Tabs defaultValue="comparison" className="w-full">
          ...
          <Tabs.Panel value="comparison" pt="md">
            <Title order={4} mb="md">Loan Comparison</Title>
            <div style={{ width: '100%', height: 300 }}>
              <ResponsiveContainer>
                <BarChart data={comparisonData}>
                  ...
                  />
                  <Bar dataKey="current" fill={chartColors.primary} name="Current Loan" />
                  <Bar dataKey="new" fill={chartColors.secondary} name="New Loan" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </Tabs.Panel>
          ...
          <Tabs.Panel value="balance" pt="md">
            <Title order={4} mb="md">Loan Balance Comparison</Title>
            <div style={{ width: '100%', height: 400 }}>
              <ResponsiveContainer>
                <AreaChart data={chartData}>
                  ...
                  />
                  <Area type="monotone" dataKey="currentBalance" stroke={chartColors.primary} fill={chartColors.primary} fillOpacity={0.3} name="Current Loan Balance" />
                  <Area type="monotone" dataKey="newBalance" stroke={chartColors.secondary} fill={chartColors.secondary} fillOpacity={0.3} name="New Loan Balance" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </Tabs.Panel>
          ...
          <Tabs.Panel value="savings" pt="md">
            <Grid>
              <Grid.Col span={{ base: 12, md: 6 }}>
                <Title order={4} mb="md">Savings Breakdown</Title>
                <Stack gap="sm">
                  <Group justify="space-between">
                    <Text>Monthly Savings:</Text>
                    <Text fw={600} c="green">${results.savings.monthly.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</Text>
                  </Group>
                  <Group justify="space-between">
                    <Text>Interest Saved:</Text>
                    <Text fw={600} c="green">${results.comparison.interestSaved.toLocaleString()}</Text>
                  </Group>
                  <Group justify="space-between">
                  ...
                  <Group justify="space-between" pt="md" style={{ borderTop: `1px solid ${isDark ? '#374151' : '#e5e7eb'}` }}>
                    <Text fw={600} size="lg">Net Savings:</Text>
                    <Text fw={700} size="lg" c={results.savings.netSavings > 0 ? 'green' : 'red'}>
              ...
              <Grid.Col span={{ base: 12, md: 6 }}>
                <Title order={4} mb="md">Interest Comparison</Title>
                <div style={{ width: '100%', height: 300 }}>
                  <ResponsiveContainer>
                    <AreaChart data={chartData}>
                      <CartesianGrid strokeDasharray="3 3" stroke={isDark ? '#374151' : '#e5e7eb'} />
                      ...
                      <Tooltip 
                        ...
                        labelFormatter={(value) => `Month ${value}`}
                      />
                      <Area type="monotone" dataKey="currentInterest" stroke={chartColors.danger} fill={chartColors.danger} fillOpacity={0.3} name="Current Loan Interest" />
                      <Area type="monotone" dataKey="newInterest" stroke={chartColors.accent} fill={chartColors.accent} fillOpacity={0.3} name="New Loan Interest" />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </Grid.Col>
