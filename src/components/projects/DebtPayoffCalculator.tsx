import { Badge, Card, Divider, Grid, Group, NumberInput, Select, SimpleGrid, Stack, Tabs, Text, TextInput, Title, Button, useMantineColorScheme } from '@mantine/core';
import { Calculator, CreditCard, DollarSign, TrendingDown, Wallet } from 'lucide-react';
        ...
        <Card shadow="sm" padding="lg" radius="md" withBorder>
          <Tabs defaultValue="comparison" className="w-full">
            ...
            <Tabs.Panel value="breakdown" pt="md">
              <Title order={4} mb="md">Debt Breakdown</Title>
